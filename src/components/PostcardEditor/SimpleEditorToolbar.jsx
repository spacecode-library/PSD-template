...
import './SimpleEditorToolbar.css';
...
const SimpleEditorToolbar = ({ cesdk, selectedBlocks }) => {
  ...
  useEffect(() => {
    ...
    if (blockType === 'text') {
      ...
      // Get text color
      try {
        const color = cesdk.block.getTextColors(block)[0];
        if (color) {
  ...
  return (
    <div className="simple-toolbar">
      <div className="toolbar-header-simple">
        <h2>Edit Tools</h2>
        <p className="toolbar-subtitle">Click on elements to edit them</p>
      </div>
      
      <div className="toolbar-content-simple">
        {selectedTextBlock ? (
          <>
